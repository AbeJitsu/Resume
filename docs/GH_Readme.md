...
**Frontend:** React, Next.js, Vue.js, TypeScript, HTML/CSS, Responsive Design, WCAG AA

**Backend:** Node.js, Express.js, Python, RESTful APIs, OAuth

**Databases:** PostgreSQL, Supabase, Redis, MongoDB

**DevOps:** Docker, Nginx, Git/GitHub, GitHub Actions, CI/CD

**AI Integration:** OpenAI API, Vercel AI SDK, RAG Patterns, Claude Code

**E-commerce:** Medusa, Stripe

---

### Beyond the Code

- Brazilian Jiu-Jitsu (Purple Belt) – discipline from the mat to the keyboard
